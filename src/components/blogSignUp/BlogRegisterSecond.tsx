...
const BlogRegisterSecond = () => {
  ...
  const isButtonActive = selectedInterests.length >= 2 && selectedInterests.length <= 5;
  ...
  return (
    <div className="w-[80%] mx-auto mt-[15rem]">
      ...
      <div className="mt-[8rem]">
        ...
        <button
  type="submit"
  className={`mx-auto ${isButtonActive ? 'bg-btn-color' : 'bg-gray-400'} mt-[16rem] mb-[10rem] items-center w-[22rem] h-[6rem] text-white py-2 rounded-2xl focus:outline-none`}
