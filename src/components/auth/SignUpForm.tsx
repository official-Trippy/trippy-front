  ...
  return (
    <form onSubmit={handleSubmit} className="w-[80%] mx-auto mt-24">
      ...
      <div className="mb-4 relative">
        ...
        <input type="email" id="email" value={email} onChange={handleEmailChange} placeholder="Trippy@trip.com" className="w-full px-4 py-2 mt-8 mb-2 h-16 rounded-xl border border-gray-300 focus:border-[#FB3463] focus:outline-none" style={{ background: 'var(--4, #F5F5F5)' }}/>
      ...
      <div className="mb-4">
        ...
        <input type="password" id="password" value={password} onChange={handlePasswordChange} placeholder="영어, 숫자, 특수 기호를 포함한 8~14자리" className="w-full px-4 py-2 mt-8 mb-2 h-16 rounded-xl border border-gray-300 focus:border-[#FB3463] focus:outline-none" style={{ background: 'var(--4, #F5F5F5)' }}/>
        <div className='h-12'>
      ...
      <div className="mb-4">
        ...
        <input type="password" id="confirmPassword" value={confirmPassword} onChange={handleConfirmPasswordChange} placeholder="영어, 숫자, 특수 기호를 포함한 8~14자리" className="w-full px-4 py-2 mt-8 mb-2 h-16 rounded-xl border border-gray-300 focus:border-[#FB3463] focus:outline-none" style={{ background: 'var(--4, #F5F5F5)' }} />
        <div className='h-12'>
