                    ...
                    {memberDatas?.result.blogName ===
                        postData?.result.member.blogName && (
                            <div className="flex ml-auto mt-[1rem] gap-[1rem]">
                                ...
                                {isOpenMenu && (
                                    <div
                                        className="absolute text-[1.2rem] flex flex-col bg-white mt-[6rem] shadow-2xl -ml-[5rem] animate-dropdown z-20 rounded-[0.8rem]"
                ...
                <div className="py-[2rem] ">
                    ...
                    <div className="w-full h-[11rem] xl:h-[32rem] lg:h-[20rem] sm:h-[11rem] rounded-[1rem] flex mt-[5rem] shadowall">
                        ...
                        <div className="w-full mt-[0.7rem] xl:mt-[5rem] lg:mt-[3rem] sm:mt-[0.7rem] relative">
                            <div className="flex justify-center">
                                <div className="w-[5rem] 2xl:w-[16rem] xl:w-[10rem] sm-700:w-[5rem]">
                                    ...
                                    <div className="w-[5rem] 2xl:w-[16rem] xl:w-[10rem] md-1000:w-[5rem] rounded-[0.8rem] flex justify-center">
                                        ...
                                        <span className={`text-[#9D9D9D] text-[0.8rem] font-semibold ${postData?.result.ticket.departure?.length > 5 || postData?.result.ticket.destination?.length > 5 ? 'text-[2rem]' : 'xl:text-[2rem] lg:text-[1.6rem] sm:text-[0.8rem]'}`}>
                            ...
                            <div className="w-[95%] border border-dashed border-[#CFCFCF] my-[1.1rem] xl:my-[4rem] lg:my-[2rem] sm:my-[1.1rem] mx-auto relative z-0" />
                            <div
