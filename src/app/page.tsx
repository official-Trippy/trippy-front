    ...
    <div>
      ...
      <RecentPost>
        <div className="flex flex-wrap">
          {boardData?.result.map((posts: any, index: number) => {
            return (
              <div className="w-[45rem] h-[20rem] shadowall rounded-[1rem] mt-[5rem] px-[1.6rem] py-[2rem] hover:-translate-y-4 duration-300 mx-[2rem] cursor-pointer" key={index}>
                <div className="flex">
                ...
                <div className="flex mt-[2rem]">
                  <div className="flex h-full text-[1.4rem] font-normal space-x-4 items-center mt-auto">
                    ...
                    <span className="">{posts.post.createDate}</span>
                  </div>
